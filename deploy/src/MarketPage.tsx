...
export default function MarketPage({ wallet, account, factoryAddress, onConnect }: Props) {
  ...
  return <div className="market-page">
    ...
    <div className="mk-content-grid">
      ...
      </section><section className="mk-market-notes"><h3>成交前，你需要知道</h3><p>仅运行中的资金池支持交易。每个钱包最多持有 49 份，订单支持部分成交。</p><p>历史已获得收益归原持有人；成交前合约会结算双方收益。外部收益结算失败时，整笔成交回滚。</p><p>整机出售表决及挂牌期间无法买卖份额，卖家仍可撤单。成交款需点击「领取 BNB」提取到钱包。</p></section></div>
    </div>
